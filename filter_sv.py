...
def map_reads_assemblies (reference, folder):
    os.system("cat " + folder + "sv_fastq/*.fastq > tmp.fastq")
    os.system("minimap2 -ax map-ont -t 26 " + reference + " tmp.fastq -Y | samtools view -b - | samtools sort > " + folder + "sv_mappings/sv_reads_to_reference.bam")
    os.system("samtools index " + folder + "sv_mappings/sv_reads_to_reference.bam")

    os.system("cat " + folder + "sv_assemblies/*.fasta > tmp.fasta")
    os.system("minimap2 -ax map-ont -t 26 " + reference + " tmp.fasta -Y | samtools view -b - | samtools sort > " + folder + "sv_mappings/sv_assemblies_to_reference.bam")
    os.system("samtools index " + folder + "sv_mappings/sv_assemblies_to_reference.bam")

    os.system("cat " + folder + "germline_fastq/*.fastq > tmp.fastq")
    os.system("minimap2 -ax map-ont -t 26 " + reference + " tmp.fastq -Y | samtools view -b - | samtools sort > " + folder + "germline_mappings/germline_reads_to_reference.bam")
    os.system("samtools index " + folder + "sv_mappings/sv_reads_to_reference.bam")

    os.system("cat " + folder + "germline_assemblies/*.fasta > tmp.fasta")
    os.system("minimap2 -ax map-ont -t 26 " + reference + " tmp.fasta -Y | samtools view -b - | samtools sort > " + folder + "germline_mappings/germline_assemblies_to_reference.bam")
    os.system("samtools index " + folder + "germline_mappings/germline_assemblies_to_reference.bam")
...
if __name__ == '__main__':
    ...
    map_reads_assemblies (args.ref, args.folder)
